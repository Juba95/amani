...
export default function ChauffeurPriveSaintTropez() {
  ...
  const heroImage = getCityExpImage('chauffeur-prive-saint-tropez');
  const heroImageCredit = getCityExpImageCredit('chauffeur-prive-saint-tropez');
  ...
  return (
    <SEOLayout>
      ...
      {heroImage && (
        <section className="px-6 md:px-10 pb-16 bg-white">
          <div className="max-w-4xl mx-auto relative aspect-[3/2] sm:aspect-[21/9] rounded-lg overflow-hidden">
            <Image src={heroImage} alt="Saint-Tropez — chauffeur privé Amani Limousines" fill priority
      ...
      <CityExperiences slug="chauffeur-prive-saint-tropez" />
    </SEOLayout>
  );
}
