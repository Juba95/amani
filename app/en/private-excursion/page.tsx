...
export const metadata: Metadata = {
  ...
  description:
    'Private day trips from Paris with a chauffeur. Versailles, Champagne, Normandy, Loire Valley, Giverny. Fully tailored itineraries, culinary guide available.',
  alternates: {
      ...
      <section className="pt-36 pb-16 px-6 md:px-10 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="heading mt-3">
            <strong>Private excursion from Paris</strong> —{' '}
            <em>with a chauffeur, at your pace</em>
          </h1>
          <p className="sf text-stone-500 mt-6 text-lg leading-relaxed max-w-2xl">
            Paris is two hours from Versailles, the Champagne vineyards and the D-Day beaches.
            A <strong>private chauffeur for a day trip from Paris</strong> means no train to
            catch, no parking to manage at the destination, and no departure time imposed by
            anyone but yourself. You arrive rested, and you leave when you are ready.
          </p>
        </div>
      </section>
