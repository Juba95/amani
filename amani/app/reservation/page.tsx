...
export default function ReservationPage() {
  ...
  // Prix estimatif basé sur une distance moyenne de 30 km si non calculée
                      ...
                      >
                        ...
                        {VEHICLES.map((v) => (
                          <option key={v.id} value={v.id}>
                            {VEHICLE_NAMES[v.id]} — {v.pax} pax — base {v.basePrice} €
                          </option>
                        ))}
                      </select>
                    </div>
                  ...
                  <div className="p-6 rounded-2xl border border-warm-300 bg-warm-50">
                    ...
                    <div className="space-y-1">
                      {[
                        ...
                        { label: 'Véhicule', val: VEHICLE_NAMES[form.vehicle] },
                      ].map((r) => (
