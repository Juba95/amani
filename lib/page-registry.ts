...
const SERVICE_FIELDS: PageField[] = [
  ...CONTENT_FIELDS,
  { key: 'tag', label: 'Badge / Étiquette (tag)', type: 'text' },
  { key: 'section_1_title', label: 'Section 1 — Titre', type: 'text' },
  { key: 'section_1_text', label: 'Section 1 — Texte', type: 'textarea' },
  { key: 'section_1_text_2', label: 'Section 1 — Texte 2', type: 'textarea' },
  { key: 'section_2_title', label: 'Section 2 — Titre', type: 'text' },
  { key: 'section_2_text', label: 'Section 2 — Texte', type: 'textarea' },
  { key: 'section_2_text_2', label: 'Section 2 — Texte 2', type: 'textarea' },
  { key: 'section_3_title', label: 'Section 3 — Titre', type: 'text' },
  { key: 'section_3_text', label: 'Section 3 — Texte', type: 'textarea' },
  { key: 'section_3_text_2', label: 'Section 3 — Texte 2', type: 'textarea' },
  { key: 'section_4_title', label: 'Section 4 — Titre', type: 'text' },
  { key: 'section_4_text', label: 'Section 4 — Texte', type: 'textarea' },
  { key: 'item_1_title', label: 'Item 1 — Titre', type: 'text' },
  { key: 'item_1_text', label: 'Item 1 — Texte', type: 'textarea' },
  { key: 'item_1_desc', label: 'Item 1 — Description', type: 'textarea' },
  { key: 'item_2_title', label: 'Item 2 — Titre', type: 'text' },
  { key: 'item_2_text', label: 'Item 2 — Texte', type: 'textarea' },
  { key: 'item_2_desc', label: 'Item 2 — Description', type: 'textarea' },
  { key: 'item_3_title', label: 'Item 3 — Titre', type: 'text' },
  { key: 'item_3_text', label: 'Item 3 — Texte', type: 'textarea' },
  { key: 'item_3_desc', label: 'Item 3 — Description', type: 'textarea' },
  { key: 'item_4_title', label: 'Item 4 — Titre', type: 'text' },
  { key: 'item_4_text', label: 'Item 4 — Texte', type: 'textarea' },
  { key: 'item_4_desc', label: 'Item 4 — Description', type: 'textarea' },
  { key: 'item_5_title', label: 'Item 5 — Titre', type: 'text' },
  { key: 'item_5_text', label: 'Item 5 — Texte', type: 'textarea' },
  { key: 'item_6_title', label: 'Item 6 — Titre', type: 'text' },
  { key: 'item_6_text', label: 'Item 6 — Texte', type: 'textarea' },
  { key: 'item_7_title', label: 'Item 7 — Titre', type: 'text' },
  { key: 'item_7_text', label: 'Item 7 — Texte', type: 'textarea' },
  { key: 'item_8_title', label: 'Item 8 — Titre', type: 'text' },
  { key: 'item_8_text', label: 'Item 8 — Texte', type: 'textarea' },
  { key: 'faq_1_title', label: 'FAQ 1 — Question', type: 'text' },
  { key: 'faq_1_text', label: 'FAQ 1 — Réponse', type: 'textarea' },
  { key: 'faq_2_title', label: 'FAQ 2 — Question', type: 'text' },
  { key: 'faq_2_text', label: 'FAQ 2 — Réponse', type: 'textarea' },
  { key: 'faq_3_title', label: 'FAQ 3 — Question', type: 'text' },
  { key: 'faq_3_text', label: 'FAQ 3 — Réponse', type: 'textarea' },
  { key: 'faq_4_title', label: 'FAQ 4 — Question', type: 'text' },
  { key: 'faq_4_text', label: 'FAQ 4 — Réponse', type: 'textarea' },
];
...
const EVENT_FIELDS: PageField[] = [
  ...
  { key: 'section_4_title', label: 'Section 4 — Titre', type: 'text' },
  { key: 'section_4_text', label: 'Section 4 — Texte', type: 'textarea' },
  { key: 'section_5_title', label: 'Section 5 — Titre', type: 'text' },
  { key: 'section_5_text', label: 'Section 5 — Texte', type: 'textarea' },
  { key: 'section_6_title', label: 'Section 6 — Titre', type: 'text' },
  { key: 'section_6_text', label: 'Section 6 — Texte', type: 'textarea' },
  { key: 'section_7_title', label: 'Section 7 — Titre', type: 'text' },
  { key: 'section_7_text', label: 'Section 7 — Texte', type: 'textarea' },
  { key: 'section_8_title', label: 'Section 8 — Titre', type: 'text' },
  { key: 'section_8_text', label: 'Section 8 — Texte', type: 'textarea' },
  { key: 'item_1_title', label: 'Item 1 — Titre', type: 'text' },
  { key: 'item_1_text', label: 'Item 1 — Période/Texte', type: 'text' },
  { key: 'item_1_desc', label: 'Item 1 — Description', type: 'textarea' },
  { key: 'item_2_title', label: 'Item 2 — Titre', type: 'text' },
  { key: 'item_2_text', label: 'Item 2 — Période/Texte', type: 'text' },
  { key: 'item_2_desc', label: 'Item 2 — Description', type: 'textarea' },
  { key: 'item_3_title', label: 'Item 3 — Titre', type: 'text' },
  { key: 'item_3_text', label: 'Item 3 — Période/Texte', type: 'text' },
  { key: 'item_3_desc', label: 'Item 3 — Description', type: 'textarea' },
  { key: 'item_4_title', label: 'Item 4 — Titre', type: 'text' },
  { key: 'item_4_text', label: 'Item 4 — Période/Texte', type: 'text' },
  { key: 'item_4_desc', label: 'Item 4 — Description', type: 'textarea' },
  { key: 'item_5_title', label: 'Item 5 — Titre', type: 'text' },
  { key: 'item_5_text', label: 'Item 5 — Période/Texte', type: 'text' },
  { key: 'item_5_desc', label: 'Item 5 — Description', type: 'textarea' },
  { key: 'item_6_title', label: 'Item 6 — Titre', type: 'text' },
  { key: 'item_6_text', label: 'Item 6 — Période/Texte', type: 'text' },
  { key: 'item_6_desc', label: 'Item 6 — Description', type: 'textarea' },
  { key: 'item_7_title', label: 'Item 7 — Titre', type: 'text' },
  { key: 'item_7_text', label: 'Item 7 — Période/Texte', type: 'text' },
  { key: 'item_7_desc', label: 'Item 7 — Description', type: 'textarea' },
  { key: 'item_8_title', label: 'Item 8 — Titre', type: 'text' },
  { key: 'item_8_text', label: 'Item 8 — Période/Texte', type: 'text' },
  { key: 'item_8_desc', label: 'Item 8 — Description', type: 'textarea' },
  { key: 'item_9_title', label: 'Item 9 — Titre', type: 'text' },
  { key: 'item_10_title', label: 'Item 10 — Titre', type: 'text' },
  { key: 'item_11_title', label: 'Item 11 — Titre', type: 'text' },
  { key: 'item_12_title', label: 'Item 12 — Titre', type: 'text' },
];
...
export const PAGE_REGISTRY: PageEntry[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'whatsapp', label: 'WhatsApp (texte affiché)', type: 'text' },
      { key: 'email', label: 'Email (affiché)', type: 'text' },
      { key: 'section_1_title', label: 'Section formulaire — Titre', type: 'text' },
      { key: 'section_1_text', label: 'Section formulaire — Texte', type: 'textarea' },
    ],
  },
  {
    slug: 'a-propos',
    ...
    fields: [
      ...CONTENT_FIELDS,
      { key: 'chauffeurs_h2', label: 'Chauffeurs — Titre de section', type: 'text' },
      { key: 'chauffeurs_p1', label: 'Chauffeurs — Paragraphe 1', type: 'textarea' },
      { key: 'chauffeurs_p2', label: 'Chauffeurs — Paragraphe 2', type: 'textarea' },
      { key: 'chauffeurs_p3', label: 'Chauffeurs — Paragraphe 3', type: 'textarea' },
    ],
  },
